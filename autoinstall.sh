...
clear
echo "====================================================="
echo "   Auto Installer Shadowsocks Google Cloud Platform"
echo "                  Ubuntu Server OS"
echo "====================================================="
echo "                   Please Wait..."
echo "====================================================="
sleep 2
...
echo "Shadowsocks IP Server        : Look Your External IP on Google Cloud Platform"
echo "Shadowsocks Server Port      : 8838"        #you can change server port on /etc/ss-config.json
echo "Shadowsocks Password         : 123456"      #you can change password on /etc/ss-config.json
echo "Shadowsocks Method           : aes-256-cfb" #you can change method on /etc/ss-config.json
echo "--------------------------------"
